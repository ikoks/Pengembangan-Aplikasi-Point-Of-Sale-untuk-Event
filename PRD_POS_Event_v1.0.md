...
| `DB-1E` | CORS Wi-Fi Lokal | Backend | ✅ **DONE** | `APP_URL=http://192.168.18.237:8000` — Konfigurasi untuk akses dari perangkat dalam jaringan Wi-Fi lokal event. |
...
╠════════════════════════╬═══════╬═══════════╬══════════════╣
║ Backend API (Laravel)  ║  12   ║     0     ║      6       ║
║ Web Admin (Blade)      ║   1   ║     1     ║      6       ║
║ Mobile Kasir (RN)      ║   2   ║     0     ║      6       ║
║ Database/Infra         ║   5   ║     0     ║      0       ║
╠════════════════════════╬═══════╬═══════════╬══════════════╣
║ TOTAL                  ║  20   ║     1     ║     18       ║
╚════════════════════════╩═══════╩═══════════╩══════════════╝
...
| Prioritas | Item | Platform |
|---|---|---|
| P0 | Integrasi ESC/POS Bluetooth Printer | Mobile |
| P0 | Pembayaran Non-Tunai (QRIS Sandbox) | Mobile + API |
| P1 | Web Dashboard — Widgets Statistik | Web |
| P1 | Web UI Kelola Menu & Harga | Web |
| P2 | Switch Operator Screen & API | Mobile + API |
...
> **Terakhir diperbarui**: 21 Juli 2026, 10:35 WIB
> **Versi PRD**: v1.0-Sprint1
