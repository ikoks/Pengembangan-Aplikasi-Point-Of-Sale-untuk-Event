    ...
    <div x-show="openForm" class="bg-white border-4 border-t-0 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-6" style="display: none;">
        <form action="{{ route('admin.sub-kategori.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    <label class="block text-xs font-extrabold uppercase mb-1">Kategori Induk <span class="text-red-600">*</span></label>
                ...
                <div>
                    <label class="block text-xs font-extrabold uppercase mb-1">Nama Sub-Kategori <span class="text-red-600">*</span></label>
...
<div class="bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
    <div class="p-5 border-b-4 border-black flex justify-between items-center">
        <div>
            <h3 class="font-extrabold text-xl uppercase tracking-tight">DAFTAR SUB-KATEGORI</h3>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse min-w-max">
            <thead class="bg-black text-white">
                <tr>
                    <th class="brutal-table-th text-xs">NAMA SUB-KATEGORI</th>
                    <th class="brutal-table-th text-xs">PARENT KATEGORI</th>
                    ...
                    <div x-data="{ open: {{ $errors->any() && old('id_sub_kategori') == $sub->id_sub_kategori ? 'true' : 'false' }} }" class="inline-block">
                        ...
                        <div x-show="open" style="display: none;" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 text-left">
                            <div @click.away="open = false" class="bg-white brutal-border brutal-shadow p-6 max-w-xl w-full">
                                <h2 class="text-xl font-black uppercase mb-4 border-b-2 border-brutal-black pb-2">Edit Sub-Kategori</h2>
                                <form action="{{ route('admin.sub-kategori.update', $sub->id_sub_kategori) }}" method="POST">
                                    ...
                                    <div class="mb-4">
                                        <label class="block font-extrabold mb-2 uppercase text-xs text-left">Kategori Induk</label>
                                    ...
                                    <div class="mb-4">
                                        <label class="block font-extrabold mb-2 uppercase text-xs text-left">Nama Sub-Kategori</label>
