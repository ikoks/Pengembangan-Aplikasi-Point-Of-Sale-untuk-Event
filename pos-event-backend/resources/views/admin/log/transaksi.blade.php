...
<div
 ...
 <div class="relative bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] w-full max-w-2xl max-h-[90vh] overflow-y-auto z-10">
  ...
  <div class="bg-black text-white p-5 flex justify-between items-center sticky top-0">
   <div>
    <h3 class="font-extrabold text-xl tracking-tight">Detail Struk Transaksi</h3>
  ...
  <div id="modalContent" class="hidden">
   ...
   <div class="p-5 border-b-4 border-black grid grid-cols-2 gap-4">
    <div>
     <p class="text-xs font-extrabold text-gray-500">Status</p>
     <p id="modalStatus" class="font-extrabold text-lg"></p>
    </div>
    <div>
     <p class="text-xs font-extrabold text-gray-500">Tanggal & Jam</p>
     <p id="modalTanggal" class="font-mono font-bold"></p>
    </div>
    <div>
     <p class="text-xs font-extrabold text-gray-500">Kasir</p>
     <p id="modalKasir" class="font-bold"></p>
    </div>
    <div>
     <p class="text-xs font-extrabold text-gray-500">Cabang</p>
     <p id="modalCabang" class="font-bold"></p>
    </div>
    <div>
     <p class="text-xs font-extrabold text-gray-500">Metode Bayar</p>
     <p id="modalMetode" class="font-bold"></p>
    </div>
    <div>
     <p class="text-xs font-extrabold text-gray-500">No. Referensi (RRN)</p>
     <p id="modalRRN" class="font-mono text-sm font-bold"></p>
    </div>
    <div>
     <p class="text-xs font-extrabold text-gray-500">Pelanggan</p>
     <p id="modalPelanggan" class="font-bold"></p>
    </div>
    <div>
     <p class="text-xs font-extrabold text-gray-500">Mode Penjualan</p>
   ...
   <div class="p-5 border-b-4 border-black">
    <h4 class="font-extrabold mb-3 text-sm tracking-tight">[ITEM PESANAN]</h4>
    <table class="w-full border-collapse">
     <thead>
      <tr>
   ...
   {{-- Rekap Keuangan --}}
   <div class="p-5 border-b-4 border-black">
    <h4 class="font-extrabold mb-3 text-sm tracking-tight">[REKAP PEMBAYARAN]</h4>
    <div class="space-y-2">
   ...
   <div id="sectionVoid" class="hidden p-5 border-b-4 border-dashed border-red-600 bg-red-50">
    <h4 class="font-extrabold mb-2 text-sm text-red-700 tracking-tight">⚠ [VOID] ALASAN PEMBATALAN</h4>
    ...
    <div class="mt-3 grid grid-cols-2 gap-2">
     <div>
      <p class="text-xs font-extrabold text-red-500">Diverifikasi Oleh</p>
      <p id="modalDiperbarui" class="font-bold text-sm text-red-800"></p>
     </div>
     <div>
      <p class="text-xs font-extrabold text-red-500">Catatan Koreksi</p>
