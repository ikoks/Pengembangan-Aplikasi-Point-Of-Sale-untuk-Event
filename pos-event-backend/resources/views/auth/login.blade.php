 ...
 <div class="w-full max-w-md animate-slide-up">
  ...
  <div class="bg-white border-4 border-brutal-black shadow-brutal-xl p-8">
   ...
   <div class="border-b-4 border-brutal-black pb-4 mb-6">
    <h2 class="text-xl text-center font-extrabold text-brutal-black tracking-tight">
   ...
   >
    ...
    <button
     id="btn-submit-login"
     type="submit"
     class="btn-brutal w-full py-1.5 bg-brutal-black text-brutal-purple font-extrabold text-xs tracking-widest border-4 border-brutal-black shadow-brutal hover:bg-brutal-purple hover:text-brutal-black transition-colors"
    >
     Masuk
    </button>
